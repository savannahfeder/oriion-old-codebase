  ...
  return (
    <div className="schedule-component">
      <ul className="schedule background-div">
        <li onClick={openSunday} className="date-item sunday-input-div">
          S
        </li>
        <li onClick={openMonday} className="date-item checked">
          M
        </li>
        <li onClick={openTuesday} className="date-item">
          T
        </li>
        <li onClick={openWednesday} className="date-item checked">
          W
        </li>
        <li onClick={openThursday} className="date-item">
          T
        </li>
        <li onClick={openFriday} className="date-item checked">
          F
        </li>
        <li onClick={openSaturday} className="date-item">
          S
        </li>
      </ul>
      ...
      <button onClick={submitSchedule} className="button hidden">
        Submit
      </button>
    </div>
  );
